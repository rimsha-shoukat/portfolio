            ...
            <div className="flex flex-col items-center justify-center w-[100%] h-[100%]">
              ...
              <div className="flex items-center justify-center w-[100%] h-[80%] font-serif">
                <div className="flex flex-col text-[#eee2ca] items-center justify-center border-2 h-auto w-[70%]">
                  ...
                  <div className="flex flex-row gap-[1.5rem] mt-[1rem]">
                  <button className="border-2 border-[#fc6c2f] rounded-full bg-transparent text-[1rem] text-[#fc6c2f] px-[1rem] py-[0.4rem] font-bold">Projects</button>
                  <button className="border-2 border-[#171a21] rounded-full bg-[#fc6c2f] text-[1rem] text-[#eee2ca] px-[1rem] py-[0.4rem] font-bold">Contact</button>
                </div>
                </div>
              </div>
            </div>
