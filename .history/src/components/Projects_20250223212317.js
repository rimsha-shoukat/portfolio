      ...
      <div className="w-[100%] h-auto flex flex-col gap-[6rem] items-center justify-center py-[2rem] px-[6rem]">
        ...
        <div className='flex flex-col w-[80%] h-auto gap-[1.5rem] font-sans text-[#eee2ca]'>
            ...
            <div className="flex flex-row gap-[2rem] text-[1.2rem]">
                ...
                <button className="select-none border-2 border-[#eee2ca] rounded-[5rem] hover:bg-[#fc6c2f] px-[1rem] py-[0.2rem] place-content-center"><FaReact className="inline text-[2.5rem] pr-[0.65rem] text-[#fc6c2f]" /> React Js</button>
            </div>
        </div>
        <div></div>
        <div></div>
