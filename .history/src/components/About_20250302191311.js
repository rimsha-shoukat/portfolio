            ...
            <div className="flex w-[50%] max-lg:w-[100%] flex-col h-auto font-sans max-sm:mx-[1rem] mx-[5rem] my-[3rem]">
                ...
                <div className="flex flex-row gap-[1rem] max-md:flex-col">
                 <Link to="">
                    ...
                    <button className="aboutBtn2 transition-all duration-700 hover:shadow-md hover:shadow-[#eee2ca] border-2 rounded-full px-[1rem] py-[0.5rem] text-[#20232a] border-[#fc6c2f] bg-[#fc6c2f] font-bold select-none">Download CV</button>
                </div>
            </div>
        </div>
       </>
