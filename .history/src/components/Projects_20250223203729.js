...
function Projects() {
  return (
    <>
      <div className="w-[100%] h-auto flex flex-col gap-[5rem] items-center justify-center py-[2rem] px-[6rem]">
        ...
        <div className='flex flex-col w-[80%] h-auto gap-0'>
            <div className='w-[100%] h-[30rem] border-2 border-solid border-white rounded-xl'>
