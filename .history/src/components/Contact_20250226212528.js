    ...
    <>
      <div className="flex font-sans flex-row px-[8rem] py-[3rem] bg-[#20232a] w-[100%] h-auto rounded-tr-[24rem] items-center justify-between">
        <div className="w-[50%] h-auto flex flex-col gap-[2rem] items-start justify-start">
         ...
         <div className="flex flex-col gap-[0.35rem] w-[90%]">
          <h2 className='text-[#eee2ca] select-none'>Enter your Email</h2>
          <input className="px-[0.75rem] py-[0.65rem] font-bold text-[0.85rem] text-[#0f1219] rounded-full" placeholder="Email here..." type="email" />
         </div>
         <div className="flex flex-col gap-0 w-[100%]">
         <h2 className="text-[#eee2ca]">Enter your message</h2>
         <input type="text" />
         </div>
         <button className="bg-[#fc6c2f] font-bold text-[1rem] rounded-full text-[#0f1219]">Send</button>
        </div>
        <div className="w-[0%] h-auto"></div>
      </div>
    </>
  )
}
