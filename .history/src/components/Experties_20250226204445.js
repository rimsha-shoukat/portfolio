...
function Experties() {
  return (
    <>
    <div className="flex flex-col items-center justify-center max-sm:px-[2rem] px-[6rem] py-[6rem] gap-[1rem] w-[100%] h-auto">
      <div className="flex flex-col gap-0 text-sans items-start justify-start w-[100%] h-auto">
        ...
        <h1 className="aboutH2 text-[3.5rem] max-sm:text-[3rem] leading-snug text-[#eee2ca] font-bold select-none">Experties</h1>
      ...
      <div className="flex max-lg:flex-col flex-row gap-[5rem] items-center justify-center w-[100%] h-auto py-[2rem]">
        <div className="flex flex-col gap-[5rem] items-center justify-center max-lg:w-[100%] w-[50%]">
            <div className="flex flex-col justify-start gap-[1rem] items-start w-[100%] h-auto">
                <div className="aboutH1 w-[100%] flex flex-row items-center justify-between">
                ...
                <div className="aboutH2 w-[100%] h-[0.23rem] bg-[#eee2ca] rounded-full">
