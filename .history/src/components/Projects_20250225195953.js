...
function Projects() {
  return (
    ...
    <div className="w-[100%] h-auto flex flex-col gap-[5rem] items-center justify-center py-[2rem] max-sm:px-[2rem] px-[6rem]">
        ...
        <div className='flex flex-col w-[40%] max-lg:w-[100%] h-auto max-xs:gap-[1rem] gap-[2rem] font-sans text-[#f9e8c7]'>
        ...
        <div className='flex flex-col w-[0%] max-lg:w-[100%] h-auto max-xs:gap-[1rem] gap-[2rem] font-sans text-[#f9e8c7]'>
            <div className='select-none w-[100%] h-auto rounded-xl'>
                <img className="select-none w-[100%] h-[100%]" src="image/coffee.png" alt="coffeeApp" />
            </div>
            <div className="select-none flex flex-row items-center justify-between">
        ...
        <div className='flex flex-col w-[50%] max-lg:w-[100%] h-auto max-xs:gap-[1rem] gap-[2rem] font-sans text-[#f9e8c7]'>
            <div className='select-none w-[100%] h-auto rounded-xl'>
                <img className="select-none w-[100%] h-[100%]" src="image/coffee.png" alt="coffeeApp" />
            </div>
            <div className="select-none flex flex-row items-center justify-between">
