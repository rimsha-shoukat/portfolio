  ...
  return (
    ...
    <div className="w-[100%] h-auto flex flex-col gap-[5rem] items-center justify-center py-[2rem] px-[2rem] sm:px-[6rem]">
        ...
        <div className='flex flex-col lg:w-[80%] w-[100%] h-auto gap-[2rem] font-sans text-[#f9e8c7]'>
            ...
            <p className='select-none text-[0.6rem] xs:text-[0,] text-justify'>Explore the Coffee App, a visual showcase that captures the essence of a coffee shop. Discover an array of coffee options in a beautifully designed interface!</p>
