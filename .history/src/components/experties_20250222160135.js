        ...
        <div className="flex flex-col gap-[5rem] items-center justify-center w-[50%]">
            <div className="flex flex-col justify-start items-start w-[100%] h-auto gap-[1rem]">
                <div className="w-[100%] flex flex-row items-center justify-between">
                    ...
                    <h2 className="text-[#eee2ca] text-[1.8rem] font-bold select-none">75%</h2>
                </div>
                <div className="w-[100%] h-[0.23rem] bg-[#eee2ca] rounded-full">
                    <div className="h-[0.25rem] w-[75%] bg-[#fc6c2f] rounded-[3rem]"></div>
                </div>
            </div>
            <div className="flex flex-col justify-start items-start w-[100%] h-auto gap-[1rem]">
                <div className="w-[100%] flex flex-row items-center justify-between">
                    <h2 className="text-[#fc6c2f] text-[1.5rem] select-none">ReactJs</h2>
                    <h2 className="text-[#eee2ca] text-[1.8rem] font-bold select-none">9%</h2>
                </div>
                <div className="w-[100%] h-[0.23rem] bg-[#eee2ca] rounded-full">
                    <div className="h-[0.25rem] w-[90%] bg-[#fc6c2f] rounded-[3rem]"></div>
                </div>
