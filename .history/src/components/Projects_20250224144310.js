    ...
    <>
      <div className="w-[100%] h-auto flex flex-col gap-[6rem] items-center justify-center py-[2rem] px-[6rem]">
        ...
        <div className='flex flex-col w-[80%] h-auto gap-[2rem] font-sans text-[#f9e8c7]'>
            ...
            <p className='select-none'>Carlex is a simple car gallery where you can browse through a collection of cars, each featuring placeholder text and basic names. Explore various car images and enjoy a straightforward visual experience!</p>
