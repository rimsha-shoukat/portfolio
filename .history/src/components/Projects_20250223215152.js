      ...
      <div className="w-[100%] h-auto flex flex-col gap-[6rem] items-center justify-center py-[2rem] px-[6rem]">
        ...
        <div className='flex flex-col w-[80%] h-auto gap-[2rem] font-sans text-[#f9e8c7]'>
            ...
            <h2 className="mr-[3rem] text-[2rem] text-[#fc6c2f]">Name</h2>
                <button className="border-2 border-[#eee2ca] rounded-xl px-[0.6rem] hover:shadow-md hover:shadow-[#fc6c2f]">
                   < FaLocationArrow className="text-[#eee2ca] text-[1.3rem] cursor-pointer select-none hover:text-[#fc6c2f]" /> 
                </button>
                <button className="border-2 border-[#eee2ca] rounded-xl px-[0.6rem]  hover:text-[#fc6c2f hover:shadow-md hover:shadow-[#fc6c2f]">
                   < FaGithub className="text-[#eee2ca] text-[1.3rem] cursor-pointer select-none hover:text-[#fc6c2f]" /> 
                </button>
            </div>
