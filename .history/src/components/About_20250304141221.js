            ...
            <div className="flex w-[50%] max-lg:w-[100%] flex-col h-auto font-sans max-sm:mx-[1rem] mx-[5rem] my-[3rem]">
                ...
                <div className="flex flex-row gap-[1rem] w-[100%] max-md:flex-col">
                 ...
                 <a rel="noopener noreferrer" target="_blank" href="https://drive.google.com/file/d/1A1E5V3aoXNESWBN3STscijUr3fmBb4d6/view?usp=drivesdk">
                    <button className="aboutBtn2 transition-all duration-700 hover:shadow-md hover:shadow-[#eee2ca] border-2 rounded-full max-xs:px- px-[1rem] py-[0.5rem] text-[#20232a] border-[#fc6c2f] bg-[#fc6c2f] font-bold select-none">View Resume</button>
                 </a>
                </div>
            </div>
        </div>
