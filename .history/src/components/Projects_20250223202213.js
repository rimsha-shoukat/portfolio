...
function Projects() {
  return (
    <>
      <div className="w-[100%] h-auto flex flex-col gap-[3rem] items-center justify-center py-[2rem] px-[6rem]">
        ...
        <div className='flex flex-col w-[80%] h-auto gap-0'>
            <div className='w-[100%] h-[20rem] border-2 border-solid border-[#0f1219] rounded-xl'>
                <img className="w-[100%] h-[100%]" src="image/about.png" alt="aboutImg" />
            </div>
            <div>
                <h2>Name</h2>
                <button>link</button>
