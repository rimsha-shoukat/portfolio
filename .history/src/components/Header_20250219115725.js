          ...
          <div className='w-[100%] h-[100%] bg-cover bg-[#171a21]/90'>
            <div className="flex flex-col items-center justify-center w-[100%] h-[100%]">
              <div className="w-[100%] h-[20%] flex items-center justify-center">
                <div className="flex flex-row gap-[1rem] items-center justify-center w-auto h-auto border-2 bg-[#0b2033] border-[#171a21] rounded-full">
                  <div className="h-[2.5rem] w-[2.5rem] border-r-2 border-[#171a21]"></div>
                  <div className="h-[2.5rem] w-[2.5rem]"></div>
                  <div className="h-[2.5rem] w-[2.5rem]"></div>
                  <div className="h-[2.5rem] w-[2.5rem]"></div>
                  <div className="h-[2.5rem] w-[2.5rem]"></div>
                  <div className="h-[2.5rem] w-[2.5rem]  border--2 border-[#171a21]"></div>
                </div>
              </div>
