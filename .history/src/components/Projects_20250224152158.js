    ...
    <>
      <div className="w-[100%] h-auto flex flex-col gap-[6rem] items-center justify-center py-[2rem] px-[6rem]">
        ...
        <div className='flex flex-col w-[80%] max-[913px]:w-[80%] max-[669px]:w-[100%] h-auto gap-[2rem] font-sans text-[#f9e8c7] max-[1017px]:w-[100%]'>
            ...
            <p className='select-none text-justify max-[517px]:text-[1.2rem]'>Explore the Coffee App, a visual showcase that captures the essence of a coffee shop. Discover an array of coffee options in a beautifully designed interface!</p>
