...
function Projects() {
  return (
    <>
      <div id="projects" className="mb-[2rem] w-[100%] h-auto flex flex-col gap-[5rem] items-center justify-center py-[2rem] max-sm:px-[2rem] px-[6rem]">
        ...
        <div className='flex flex-row items-center justify-center max-lg:flex-col w-[100%] h-auto max-xs:gap-[1rem] max-lg:gap-[2rem] gap-[4rem] font-sans text-white'>
              ...
              <h2 className="max-xs:text-[1.2rem] text-[2rem] text-[#fc6c2f] text-nowrap">Coffee App</h2>
                ...
                <a href="https://github.com/rimsha-shoukat/coffeeApp.git" target="_blank" rel="noopener noreferrer">
                  <button className="border-2 border-[#eee2ca] rounded-xl py-[0.65rem] px-[0.65rem] hover:shadow-md hover:shadow-[#fc6c2f] group">
        ...
        <div className='flex flex-row-reverse items-center justify-center max-lg:flex-col w-[100%] h-auto max-xs:gap-[1rem] max-lg:gap-[2rem] gap-[4rem] font-sans text-white'>
              <div className='select-none max-lg:w-[100%] w-[26%] rounded-xl'>
                <a href="https://rimsha-shoukat.github.io//" target="_blank" rel="noopener noreferrer"> 
                <img className="proj select-none max-lg:block hidden w-[100%] h-[100%]" src="image/coffee.png" alt="ecommerce-frontend-design" />
                </a>
                <a href="https://rimsha-shoukat.github.io/ecommerce-frontend-design/" target="_blank" rel="noopener noreferrer"> 
                  <img className="proj select-none max-lg:hidden block w-[100%] h-[100%]" src="image/coffee1.png" alt="ecommerce-frontend-design" />
                </a>
              </div>
              <div className="aboutH1 flex flex-col justify-center items-start max-lg:w-[100%] w-[45%] gap-[2rem] max-xs:gap-[1rem]">
              <div className="select-none w-[100%] flex flex-row items-center justify-between">
              <h2 className="max-xs:text-[1.2rem] text-[2rem] text-[#fc6c2f] text-nowrap">E commerce web design</h2>
                  <div className="flex flex-row gap-[0.65rem]">
                  <a href="https://rimsha-shoukat.github.io/ecommerce-frontend-design/" target="_blank" rel="noopener noreferrer"> 
                    <button className="border-2 border-[#eee2ca] rounded-xl py-[0.65rem] px-[0.65rem] hover:shadow-md hover:shadow-[#fc6c2f] group">
                      < FaLocationArrow className="text-white max-xs:text-[0.65rem] text-[1.3rem] cursor-pointer select-none group-hover:text-[#fc6c2f]" /> 
                  ...
                  <a href="https://github.com/rimsha-shoukat/ecommerce-frontend-design.git" target="_blank" rel="noopener noreferrer"> 
                  <button className="border-2 border-[#eee2ca] rounded-xl py-[0.65rem] px-[0.65rem] hover:shadow-md hover:shadow-[#fc6c2f] group">
                    < FaGithub className="text-white max-xs:text-[0.65rem] text-[1.3rem] cursor-pointer select-none group-hover:text-[#fc6c2f]" /> 
                  </button>
                  </a>
        ...
        <div className='flex flex-row items-center justify-center max-lg:flex-col w-[100%] h-auto max-xs:gap-[1rem] max-lg:gap-[2rem] gap-[4rem] font-sans text-white'>
              <div className='select-none max-lg:w-[100%] w-[26%] rounded-xl'>
              <a href="https://rimsha-shoukat.github.io/shoppey" target="_blank" rel="noopener noreferrer">
                  <img className="proj select-none max-lg:block hidden w-[100%] h-[100%]" src="image/coffee.png" alt="data analysis" />
              </a>
              <a href="https://rimsha-shoukat.github.io/shoppey" target="_blank" rel="noopener noreferrer">
                  <img className="proj select-none max-lg:hidden block w-[100%] h-[100%]" src="image/coffee.png" alt="data analysis" />
              </a>
              </div>
              <div className="aboutH1 flex flex-col justify-center items-start max-lg:w-[100%] w-[45%] gap-[2rem] max-xs:gap-[1rem]">
              <div className="select-none w-[100%] flex flex-row items-center justify-between">
              <h2 className="max-xs:text-[1.2rem] text-[2rem] text-[#fc6c2f] text-nowrap">Data Analysis</h2>
                  <div className="flex flex-row gap-[0.65rem]">
                  <a href="https://rimsha-shoukat.github.io/weatherApp" target="_blank" rel="noopener noreferrer">
                  <button className="border-2 border-[#eee2ca] rounded-xl py-[0.65rem] px-[0.65rem] hover:shadow-md hover:shadow-[#fc6c2f] group">
                    < FaLocationArrow className="text-white max-xs:text-[0.65rem] text-[1.3rem] cursor-pointer select-none group-hover:text-[#fc6c2f]" /> 
                  </button>
                  </a>
                  <a href="https://github.com/rimsha-shoukat/WeatherApp" target="_blank" rel="noopener noreferrer">
                  <button className="border-2 border-[#eee2ca] rounded-xl py-[0.65rem] px-[0.65rem] hover:shadow-md hover:shadow-[#fc6c2f] group">
                    < FaGithub className="text-white max-xs:text-[0.65rem] text-[1.3rem] cursor-pointer select-none group-hover:text-[#fc6c2f]" /> 
                  </button>
                  </a>
