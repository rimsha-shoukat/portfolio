    ...
    <>
      <div className="w-[100%] h-auto flex flex-col gap-[6rem] items-center justify-center py-[2rem] px-[6rem]">
        ...
        <div className='flex flex-col w-[80%] h-auto gap-[1.5rem] font-sans text-[#eee2ca]'>
            ...
            <div className="select-none flex flex-row gap-[1rem] text-[2rem]">
                <h2>Name</h2>
                <button className="border-2 border-[#eee2ca] rounded-xl">
                   < FaGithub className="text-[#eee2ca] text-2xl px-[0.5rem] cursor-pointer" /> 
                </button>
                <button>git</button>
            </div>
            <div>
