            ...
            <div className="flex flex-col items-center justify-center w-[100%] h-[100%]">
              ...
              <div className="flex items-center justify-center w-[100%] h-[80%]">
                <div className="flex flex-col text-[#eee2ca] items-center justify-center h-auto max-lg:w-[90%] w-[70%]">
                  ...
                  <h1 className="secondHeadingAnim text-[4.5rem] m:text-[4rem] sm:text-[3rem] text-[1.8rem] text-nowrap cursor-default font-bold select-none">A Frontend Developer.</h1>
