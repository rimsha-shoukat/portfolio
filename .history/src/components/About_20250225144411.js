       ...
       <div className="flex flex-row items-center justify-center gap-[1rem] rounded-bl-[28rem] rounded-br-[10rem] w-[100%] h-auto bg-[#20232a] p-[4rem] font-sans">
            ...
            <div className="flex flex-col w-auto h-auto font-sans mx-[5rem] my-[3rem]">
                ...
                <div className="flex flex-row gap-[1rem]">
                    <button className="aboutBtn1 hover:rotate- transition-all duration-700 hover:shadow-md hover:shadow-[#fc6c2f] border-2 rounded-full px-[1rem] py-[0.5rem] border-[#eee2ca] text-[#fc6c2f] font-bold select-none ">Contact Me</button>
