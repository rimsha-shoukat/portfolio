...
function About(){
    return(
       <>
       <div className="flex flex-row max-lg:flex-col items-center justify-center gap-[0.5rem] rounded-bl-[24rem] w-[100%] h-auto bg-[#20232a] max-lg:px-[] px-[2rem] py-[4rem] font-sans">
