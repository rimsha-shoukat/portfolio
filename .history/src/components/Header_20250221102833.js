          ...
          <div className='w-[100%] h-[100%] bg-cover bg-[#171a21]/90'>
            <div className="flex flex-col items-center justify-center w-[100%] h-[100%]">
              ...
              <div className="flex items-center justify-center w-[100%] h-[80%]">
                <div className="flex flex-col text-[#eee2ca] items-center justify-center text-lg border-2 h-auto w-[70%]">
                  <h1 className="text-[clamp(1rem,4.5rem,6rem)] cursor-default font-bold leading-none">Hello, I am <b className="text-[#fc6c2f]"> Rimsha </b> </h1>
                  <h1 className="text-[clamp(1rem,4.5rem,6rem)] cursor-default font-bold">A Frontend Developer.</h1>
                  <p className="cursor-default text-center text-[clamp(0.5rem, 1.5rem,3rem)] px-[2rem] place-content-center">I craft sleek, responsive websites that seamlessly integrate intuitive design with advanced functionality, prioritizing user end experience and business objectives.</p>
