  ...
  return (
    ...
    <div className="flex flex-col items-center justify-center px-[7rem] py-[7rem] gap-[1rem] w-[100%] h-auto">
      ...
      <div className="flex flex-row max-[879px]:flex-col gap-[4rem] items-center justify-center w-[100%] h-auto py-[2rem]">
        <div className="flex flex-col gap-[5rem] items-center justify-center max-[879px]:w-[90%] w-[50%]">
        ...
        <div className="flex flex-col max-[879px]:w-[90%] max-[615px]:w-[90%] gap-[5rem] items-center justify-center w-[50%]">
