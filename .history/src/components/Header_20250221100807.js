          ...
          <div className='w-[100%] h-[100%] bg-cover bg-[#171a21]/90'>
            <div className="flex flex-col items-center justify-center w-[100%] h-[100%]">
              ...
              <div className=" flex items-center justify-center w-[100%] h-[80%]">
                <div className="flex flex-col text-[#eee2ca] items-center justify-center border-2 h-auto w-[70%] font-sans
  ">
                  <h1 className="capitalize text-[4.5rem] cursor-default leading-[4rem]">Hello, I am <b className="text-[#fc6c2f]"> Rimsha </b> </h1>
                  <h1 className="capitalize text-[4.5rem] cursor-default"> a frontend developer.</h1>
                  <p className="cursor-default text-center text-lg/6 px-[2rem] place-content-center font-sans">I craft sleek, responsive websites that seamlessly integrate intuitive design with advanced functionality, prioritizing user end experience and business objectives.</p>
