      ...
      <div className="w-[100%] h-auto flex flex-col gap-[6rem] items-center justify-center py-[2rem] px-[6rem]">
        ...
        <div className='flex flex-col w-[80%] max-[913px]:w-[80%] max-[669px]:w-[100%] h-auto gap-[2rem] font-sans text-[#f9e8c7] max-[1017px]:w-[100%]'>
            ...
            <h2 className="mr-[3rem] max-[461px]:mr-[0.5rem] max-[420px]:mr-0 max-[452px]:text-[1.2rem] max-[561px]:text-[1.5rem] max-[493px]:mr-[1rem] text-[2rem] text-[#fc6c2f]">Coffee App</h2>
                <button className="border-2 border-[#eee2ca] rounded-xl max-[452px]:py-[0.65rem] px-[0.65rem] max-[420px]:px-0 max-[420px]:py-0 max-[420px] hover:shadow-md hover:shadow-[#fc6c2f] group max-[452px]:border-none">
