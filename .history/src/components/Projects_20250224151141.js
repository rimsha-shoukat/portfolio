    ...
    <>
      <div className="w-[100%] h-auto flex flex-col gap-[6rem] items-center justify-center py-[2rem] px-[6rem]">
        ...
        <div className='flex flex-col w-[80%] h-auto gap-[2rem] font-sans text-[#f9e8c7] max-[1017px]:w-[100%]'>
            <div className='select-none w-[100%] h-[30rem] rounded-xl hidden max-[913px]:block'>
                <img className="select-none w-[100%] h-[100%] hidden max-[913px]:hidden" src="image/coffee.png" alt="coffeeApp" />
