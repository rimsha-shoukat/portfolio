...
function About(){
    return(
       <>
       <div className="flex lg:flex-row flex-col items-center justify-center gap-[0.5rem] rounded-bl-[28rem] rounded-br-[10rem] w-[100%] h-auto bg-[#20232a] px-[2rem] py-[4rem] font-sans">
            <img className="aboutImg w-[30rem] h-auto select-none" src="image/about.png" alt="aboutImage" />
            <div className="flex flex-col w-auto h-auto font-sans max-sm:mx-[1rem] mx-[5rem] my-[3rem]">
                <h1 className="aboutH1 text-[1.6rem] select-none leading-none text-[#fc6c2f] font-bold">Know</h1>
                <h1 className="aboutH2 text-[3.2rem] max-smtext-[2.8rem] text-[#eee2ca] font-bold select-none">About Me</h1>
                ...
                <div className="flex md:flex-row gap-[1rem] flex-col">
