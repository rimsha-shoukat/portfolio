         ...
         <div className="flex flex-col items-start justify-start gap-0">
          ...
          <form onSubmit={onSubmit} className="w-[100%] h-auto flex flex-col gap-[1.2rem]">
            ...
            <div className="aboutH2 flex flex-col w-[100%] gap-[0.35rem]">
              ...
              } className="bg-[#0f1219] px-[1rem] py-[0.65rem] text-sm text-[#eee2ca] rounded-full" placeholder="Enter your email" type="email" name="Email" required />
            </div>
            <div className="aboutH2 flex flex-col gap-[0.35rem] w-[100%]">
              <label className='text-[#eee2ca] text-sm select-none'>Message</label>
              <textarea onChange={
                e => setMessage(e.target.value)
              } rows="5" className="px-[1rem] py-[0.65rem] bg-[#0f1219] text-sm text-[#eee2ca] rounded-xl" placeholder="Type your message" type="text" name="Messsage" required />
            </div>
            <div className="w-[100%] h-auto">
            <button type="submit" onClick={() => sendMessage()} className="bg-[#fc6c2f] w-[100%] h-[2.5rem] mt-[1rem] transition-all duration-700 shadow-lg shadow-[#0f1219] hover:bg-[#ff8c52f5] select-none font-bold text-[1rem] rounded-full text-[#0f1219]">Send Message</button>
            </div>
          </form>
         </div>
