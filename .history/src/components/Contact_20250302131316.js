        ...
        <div className="w-[50%] max-lg:w-[100%] max-md:px-0 px-[3rem] h-auto flex flex-col gap-[2rem] items-start justify-start">
         <div className="flex flex-col items-start justify-start gap-0">
          ...
          <form onSubmit={onSubmit} className="w-[100%] h-auto flex flex-col gap-[1.2rem]">
            ...
            <button type="submit" className="bg-[#fc6c2f] w-[100%] h-[2.5rem] mt-[1rem] transition-all duration-700 shadow-lg shadow-[#0f1219] hover:bg-[# #fc6c2f] select-none font-bold text-[1rem] rounded-full text-[#0f1219]">Send Message</button>
            </div>
          </form>
         </div>
