...
function Projects() {
  return (
    ...
    <div className="w-[100%] h-auto flex flex-col gap-[5rem] items-center justify-center py-[2rem] max-sm:px-[2rem] px-[6rem]">
        ...
        <div className='flex flex-row max-lg:flex-col w-[100%] max-lg:w-[100%] h-auto max-xs:gap-[1rem] gap-[2rem] font-sans text-[#f9e8c7]'>
            ...
            <div className="flex flex-col max-lg:w-[100%] w-[50%] gap-[2rem] max-xs:gap-[1rem]">
