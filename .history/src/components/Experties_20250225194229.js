  ...
  return (
    ...
    <div className="flex flex-col items-center justify-center max-sm:px-[2rem] px-[6rem] py-[6rem] gap-[1rem] w-[100%] h-auto">
      <div className="flex flex-col gap-0 text-sans items-start justify-start w-[100%] h-auto">
        ...
        <h1 className="expH2 sm:text-[3.5rem] max-sm:text-[3rem] leading-snug text-[#eee2ca] font-bold select-none">Experties</h1>
        <div className="expU h-[0.30rem] w-[4rem] bg-[#fc6c2f] border-none rounded-[5rem] select-none"></div>
      </div>
      <div className="flex flex-col md:flex-row md:gap-[4rem] gap-[5rem] items-center justify-center w-[100%] h-auto py-[2rem]">
