  ...
  return (
    ...
    <div className="w-[100%] h-auto flex flex-col gap-[5rem] items-center justify-center py-[2rem] max-sm:px-[2rem] px-[6rem]">
        ...
        <div className='flex flex-col w-[80%] max-lg:w-[100%] h-auto max-xs:gap-[1rem] gap-[2rem] font-sans text-[#f9e8c7]'>
            ...
            <p className='select-none matext-[0.65rem] text-[1rem] text-justify'>Explore the Coffee App, a visual showcase that captures the essence of a coffee shop. Discover an array of coffee options in a beautifully designed interface!</p>
