...
function Contact() {
  return (
    <>
      <div className="flex font-sans flex-row max-lg:flex-col-reverse px-[8rem] max-lg:ga[] py-[3rem] bg-[#20232a] w-[100%] h-auto rounded-tr-[24rem] items-center justify-between">
