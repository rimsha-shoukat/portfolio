      ...
      <div className="flex font-sans flex-row max-lg:flex-col-reverse max-sm:px-[2rem] px-[8rem] gap-[4rem] py-[3.5rem] bg-[#20232a] w-[100%] h-auto rounded-tr-[24rem] items-center justify-center">
        <div className="w-[50%] max-lg:w-[100%] max-md:px-0 px-[3rem] h-auto flex flex-col gap-[1.8rem] items-start justify-start">
         ...
         <div className="aboutH2 flex flex-col w-[100%] gap-[0.35rem]">
          <label className='text-[#eee2ca] select-none'>Enter your Email</label>
          <input onChange={
            e => setEmail(e.target.value)
          } className="bg-[#0f1219] px-[1rem] py-[0.5rem] font-bold max-xs:text-[0.8rem] text-[1rem] text-[#eee2ca] rounded-full" placeholder="Email here..." type="email" required />
         </div>
         <div className="aboutH2 flex flex-col gap-[0.35rem] w-[100%]">
          <label className='text-[#eee2ca] select-none'>Enter your Message</label>
          <textarea onChange={
            e => setMessage(e.target.value)
          } rows="5" className="max-xs:text-[0.8rem] px-[1rem] py-[0.5rem] font-bold bg-[#0f1219] text-[1rem] text-[#eee2ca] rounded-xl" placeholder="Message here..." type="text" required />
         </div>
         <div className="w-[100%] h-auto">
         <p className={`${valid ? 'text-[#008000]' : 'text-[#FF0000]'} w-[100%] h-[1.2rem] select-none text-sm text-center`}>{err}</p>
         <button type="submi" onClick={() => sendMessage()} className="bg-[#fc6c2f] w-[100%] py-[0.35rem] transition-all duration-700 hover:shadow-lg hover:shadow-[#0f1219] hover:bg-[#e76a2bf5] select-none font-bold text-[1.2rem] rounded-full text-[#0f1219]">Send</button>
         </div>
         </form>
         </div>
