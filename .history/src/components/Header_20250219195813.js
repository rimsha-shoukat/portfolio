          ...
          <div className='w-[100%] h-[100%] bg-cover bg-[#171a21]/90'>
            <div className="flex flex-col items-center justify-center w-[100%] h-[100%]">
              ...
              <div className="flex items-center justify-center w-[100%] h-[80%] font-serif">
                <div className="flex flex-col text-[#eee2ca] items-center justify-center border-2 h-auto w-[70%] p">
                  <h1 className="capitalize text-[5rem] leading-[5rem] cursor-default place-centent-center">Hello, I am <spam className="text-[#fc6c2f]"> Rimsha </spam> <br/> a frontend developer.</h1>
                  <p className="cursor-default text-xl/8">I craft sleek, responsive websites that seamlessly integrate intuitive design with advanced functionality, prioritizing user end experience and business objectives.</p>
