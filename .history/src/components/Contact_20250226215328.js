  ...
  return (
    <>
      <div className="flex font-sans flex-row max-lg:flex-col-reverse px-[8rem] max-lg:gap-[4rem] py-[3rem] bg-[#20232a] w-[100%] h-auto rounded-tr-[24rem] items-center justify-center">
        <div className="w-[50%] max-lg:w-[100%] px-[5rem] h-auto flex flex-col gap-[2rem] items-start justify-start">
         ...
         <div className="flex flex-col w-[] gap-[0.35rem]">
         ...
         <button className="bg-[#fc6c2f] py-[0.35rem] select-none font-bold text-[1.2rem] rounded-full text-[#0f1219]">Send</button>
        </div>
