...
function Projects() {
  return (
    <>
    <div className="w-[100%] h-auto flex flex-col gap-[2rem] sm:gap-[6rem] items-center justify-center py-[2rem] px-[6rem]">
        ...
        <div className='flex flex-col lg:w-[80%] w-[100%] h-auto gap-[2rem] font-sans text-[#f9e8c7]'>
            <div className='select-none w-[100%] h-auto rounded-xl'>
                <img className="select-none w-[100%] h-[100%] hidden sm:block" src="image/coffee.png" alt="coffeeApp" />
                <img className="select-none w-[100%] h-[100%] block sm:hidden" src="image/coffee1.png" alt="coffeeApp" />
            </div>
