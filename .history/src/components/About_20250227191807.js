...
function About(){
    return(
       ...
       <div className="flex lg:flex-row flex-col items-center justify-center gap-[0.5rem] rounded-bl-[24rem] w-[100%] h-auto bg-[#20232a] px-[2rem] py-[4rem] font-sans">
            <img className="aboutImg w-[50%] h-auto select-none" src="image/about.png" alt="aboutImage" />
            <div className="flex w-[50] flex-col w-auto h-auto font-sans max-sm:mx-[1rem] mx-[5rem] my-[3rem]">
