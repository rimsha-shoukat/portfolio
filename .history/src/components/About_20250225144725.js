...
function About(){
    return(
       <>
       <div className="flex lg:flex-row flex-col items-center justify-center gap-[0.5rem] rounded-bl-[28rem] rounded-br-[10rem] w-[100%] h-auto bg-[#20232a] p-[4rem] font-sans">
