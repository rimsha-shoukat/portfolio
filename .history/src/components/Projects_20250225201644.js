  ...
  return (
    ...
    <div className="w-[100%] h-auto flex flex-col gap-[5rem] items-center justify-center py-[2rem] max-sm:px-[2rem] px-[6rem]">
        ...
        <div className='flex flex-row max-lg:flex-col w-[100%] h-auto max-xs:gap-[1rem] gap-[2rem] font-sans text-[#f9e8c7]'>
            <div className='select-none max-lg:w-[100%] w-[60%] h-auto rounded-xl'>
                <img className="select-none w-[100%] h-[100%]" src="image/coffee.png" alt="coffeeApp" />
            </div>
            <div className="flex flex-col justify-center items-start max-lg:w-[100%] w-[40%] gap-[2rem] max-xs:gap-[1rem]">
            ...
            <div className="flex w-[100] max-xs:flex-col flex-row gap-[1.5rem] text-[0.85rem]">
