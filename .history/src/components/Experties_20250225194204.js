...
function Experties() {
  return (
    <>
    <div className="flex flex-col items-center justify-center max-sm:px-[2rem] sm:px-[6rem] py-[6rem] gap-[1rem] w-[100%] h-auto">
      <div className="flex flex-col gap-0 text-sans items-start justify-start w-[100%] h-auto">
        ...
        <h1 className="expH2 sm:text-[3.5rem] text-[3rem] leading-snug text-[#eee2ca] font-bold select-none">Experties</h1>
