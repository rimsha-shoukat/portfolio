...
function Contact() {
  return (
    <>
      <div className="flex font-sans flex-row px-[10rem] py-[3rem] bg-[#20232a] w-[100%] h-auto rounded-tr-[24rem] items-center justify-center">
        <div className="w-[60%] h-auto flex flex-col gap-[4rem] items-start justify-start">
