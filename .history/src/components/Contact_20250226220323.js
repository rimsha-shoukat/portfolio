...
function Contact() {
  return (
    <>
      <div className="flex font-sans flex-row max-lg:flex-col-reverse max-sm:px-[2rem] px-[8rem] max-lg:gap-[4rem] py-[rem] bg-[#20232a] w-[100%] h-auto rounded-tr-[24rem] items-center justify-center">
