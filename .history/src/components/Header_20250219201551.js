          ...
          <div className='w-[100%] h-[100%] bg-cover bg-[#171a21]/90'>
            <div className="flex flex-col items-center justify-center w-[100%] h-[100%]">
              ...
              <div className="flex items-center justify-center w-[100%] h-[80%] font-serif">
                <div className="flex flex-col text-[#eee2ca] items-center justify-center gap-[1rem] border-2 h-auto w-[70%]">
                  <h1 className="capitalize text-[4.5rem] cursor-default font-extrabold">Hello, I am <spam className="text-[#fc6c2f]"> Rimsha </spam> </h1>
                  ...
                  <button className="border-2 border-[#fc6c2f] rounded-full bg-transparent text-[1rem] text-[#fc6c2f]">My work -@</button>
                  <button className="border-2 border-[]">contact -?</button>
                </div>
                </div>
              </div>
            </div>
