...
function Projects() {
  return (
    ...
    <div className="mb-[2rem] w-[100%] h-auto flex flex-col gap-[5rem] items-center justify-center py-[2rem] max-sm:px-[2rem] px-[6rem]">
        ...
        <h1 className="aboutH1 text-[1.6rem] select-nonee leading-nonee text-[#fc6c2f] font-bold">My</h1>
        <h1 className="aboutH2 text-[3.2rem] text-[#eee2ca] font-bold select-nonee">Projects</h1>
        <div className="aboutUnder w-[4rem] h-[0.30rem] bg-[#fc6c2f] rounded-[5rem] select-nonee"></div>
        </div>
        <div className='flex flex-row items-center justify-center max-lg:flex-col w-[100%] h-auto max-xs:gap-[1rem] max-lg:gap-[2rem] gap-[4rem] font-sans text-[#f9e8c7]'>
            <div className='select-nonee max-lg:w-[100%] w-[26%] rounded-xl'>
                <img className="select-nonee max-lg:block hidden w-[100%] h-[100%]" src="image/coffee.png" alt="coffeeApp" />
                <img className="select-nonee max-lg:hidden block w-[100%] h-[100%]" src="image/coffee1.png" alt="coffeeApp" />
            </div>
            <div className="flex flex-col justify-center items-start max-lg:w-[100%] w-[45%] gap-[2rem] max-xs:gap-[1rem]">
            <div className="select-nonee w-[100%] flex flex-row items-center justify-between">
            <h2 className="max-xs:text-[1.2rem] text-[2rem] text-[#fc6c2f] text-nowrap">Coffee App</h2>
                ...
                <button className="border-2 border-[#eee2ca] rounded-xl py-[0.65rem] px-[0.65rem] hover:shadow-md hover:shadow-[#fc6c2f] group">
                   < FaLocationArrow className="text-[#eee2ca] max-xs:text-[0.65rem] text-[1.3rem] cursor-pointer select-nonee group-hover:text-[#fc6c2f]" /> 
                </button>
                <button className="border-2 border-[#eee2ca] rounded-xl py-[0.65rem] px-[0.65rem] hover:shadow-md hover:shadow-[#fc6c2f] group">
                   < FaGithub className="text-[#eee2ca] max-xs:text-[0.65rem] text-[1.3rem] cursor-pointer select-nonee group-hover:text-[#fc6c2f]" /> 
                </button>
                </div>
            </div>
            <p className='select-nonee max-xs:text-[0.65rem] text-[1rem] text-justify'>Explore the Coffee App, a visual showcase that captures the essence of a coffee shop. Discover an array of coffee options in a beautifully designed interface!</p>
            <div className="flex max-xs:flex-col max-xs:gap-[1rem] flex-row w-[100%] max-xs:text-[0.5rem] gap-[1.5rem] text-[0.85rem]">
                <button className="hover:rotate-180 transition-all duration-700 shadow-md shadow-[#fc6c2f] hover:shadow-none select-nonee border-2 border-[#eee2ca] rounded-[5rem] px-[1rem] max-xs:py-[0.1rem] py-[0.2rem] place-content-center"><RiTailwindCssFill className="inline max-xs:text-[1.5rem] text-[2rem] pr-[0.65rem] text-[#fc6c2f]" />Tailwind CSS</button>
        ...
        <div className='flex flex-row-reverse items-center justify-center max-lg:flex-col w-[100%] h-auto max-xs:gap-[1rem] max-lg:gap-[2rem] gap-[4rem] font-sans text-[#f9e8c7]'>
            <div className='select-nonee max-lg:w-[100%] w-[26%] rounded-xl'>
                <img className="select-nonee max-lg:block hidden w-[100%] h-[100%]" src="image/car.png" alt="coffeeApp" />
                <img className="select-nonee max-lg:hidden block w-[100%] h-[100%]" src="image/car1.png" alt="coffeeApp" />
            </div>
            <div className="flex flex-col justify-center items-start max-lg:w-[100%] w-[45%] gap-[2rem] max-xs:gap-[1rem]">
            <div className="select-nonee w-[100%] flex flex-row items-center justify-between">
        ...
        <div className='flex flex-row items-center justify-center max-lg:flex-col w-[100%] h-auto max-xs:gap-[1rem] max-lg:gap-[2rem] gap-[4rem] font-sans text-[#f9e8c7]'>
            <div className='select-nonee max-lg:w-[100%] w-[26%] rounded-xl'>
                <img className="select-nonee max-lg:block hidden w-[100%] h-[100%]" src="image/web.png" alt="coffeeApp" />
                <img className="select-nonee max-lg:hidden block w-[100%] h-[100%]" src="image/web1.png" alt="coffeeApp" />
            </div>
            <div className="flex flex-col justify-center items-start max-lg:w-[100%] w-[45%] gap-[2rem] max-xs:gap-[1rem]">
            <div className="select-nonee w-[100%] flex flex-row items-center justify-between">
