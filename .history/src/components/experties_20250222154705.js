...
function Experties() {
  return (
    ...
    <div className="flex flex-col items-center justify-center px-[7rem] py-[7rem] gap-[1rem] w-[100%] h-auto">
      ...
      <div className="flex flex-row gap-[1rem] items-center justify-center w-[100%] h-auto py-[2rem]">
        <div className="flex flex-col items-center justify-center w-[50%]">
            <div className="flex flex-col justify-start items-start w-[100%] h-auto">
        ...
        <div className="flex flex-col items-center justify-center w-[50%]">
            <div className="flex flex-col justify-start items-start w-[0%] h-auto">
                <div className="w-[100%] flex flex-row items-center justify-between">
                    <h2 className="text-[#fc6c2f] text-[1.5rem] select-none">HTML5</h2>
                    <h2 className="text-[#eee2ca] text-[1.8rem] font-bold select-none">90%</h2>
                </div>
