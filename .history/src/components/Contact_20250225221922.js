  ...
  return (
    <>
      <div className="flex font-sans flex-row gap-[2rem] px-[6rem] py-[2rem] bg-[#20232a] w-[100%] h-auto rounded-tr-[24rem] items-center justify-center">
        <div className="w-auto h-auto flex flex-col gap-[1rem] items-center justify-start">
            <h1 className='text-[#fc8b2f] text-[1.2rem] select-none'>Inquiry</h1>
            <h1 className="text-[4rem] text-[#eee2ca]">Contact Me</h1>
