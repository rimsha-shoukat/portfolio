            ...
            <div className="flex flex-col items-center justify-center w-[100%] h-[100%]">
              ...
              <div className="flex items-center justify-center w-[100%] h-[80%] font-serif">
                <div className="flex flex-col text-[#eee2ca] items-center justify-center border-2 h-auto w-[70%]">
                  <h1 className="capitalize text-[5rem] cursor-default font-extrabold leading-[3.5rem]">Hello, I am <spam className="text-[#fc6c2f]"> Rimsha </spam> </h1>
                  <h1 className="capitalize text-[5rem] cursor-default font-extrabold"> a frontend developer.</h1>
