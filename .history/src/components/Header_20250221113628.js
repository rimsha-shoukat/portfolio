            ...
            <div className="flex flex-col items-center justify-center w-[100%] h-[100%]">
              ...
              <div className="flex items-center justify-center w-[100%] h-[80%]">
                <div className="flex flex-col text-[#eee2ca] items-center justify-center h-auto w-[70%]">
                  ...
                  <button className="rounded-full bg-[#fc6c2f] text-[1rem] text-[#171a21] px-[1rem] py-[0.4rem] font-bold w-auto mt-[1.5rem] group select-none">My Work <FaArrowRight className="inline pl-[0.2rem] text-[1.2rem]  group-hover:rotate-90" /></button>
