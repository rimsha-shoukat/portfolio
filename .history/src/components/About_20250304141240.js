       ...
       <div className="flex flex-row max-lg:flex-col items-center justify-center gap-[0.5rem] rounded-bl-[24rem] w-[100%] h-auto bg-[#20232a] max-lg:px-[5rem] max-sm:px-[2rem] px-[2rem] py-[4rem] font-sans">
            ...
            <div className="flex w-[50%] max-lg:w-[100%] flex-col h-auto font-sans max-sm:mx-[1rem] mx-[5rem] my-[3rem]">
                ...
                <div className="flex flex-row gap-[1rem] w-[100%] max-md:flex-col">
                 <Link to="#contact">
                    <button className="aboutBtn1 transition-all duration-700 hover:shadow-md hover:shadow-[#fc6c2f] border-2 rounded-full max-xs:px px-[1rem] py-[0.5rem] border-[#eee2ca] text-[#fc6c2f] font-bold select-none ">Contact Me</button>
                 </Link>
