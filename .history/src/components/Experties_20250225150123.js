...
function Experties() {
  return (
    ...
    <div className="flex flex-col items-center justify-center px-[6rem] py-[6rem] gap-[1rem] w-[100%] h-auto">
      ...
      <div className="flex flex-col md:flex-row gap-[4rem] items-center justify-center w-[100%] h-auto py-[2rem]">
        <div className="flex flex-col gap-[5rem] items-center justify-center w-[1] md:w-[50%]">
