        ...
        <div className="h-screen bg-cover bg-no-repeat bg-header">
          <div className='w-[100%] h-[100%] bg-cover bg-[#171a21]/90'>
            <div className="flex flex-col items-center justify-center w-[100%] h-[100%]">
              ...
              <div className="place-content-center items-center w-[100%] h-[80%] border-2 border-red-800">
                <div className="flex flex-col gap-[2rem] items-center justify-center border-2 h-auto w-[60%]">
                  <h1>hello, i am rimsha a frontend developer.</h1>
                  <p>i craft sleek, responsive websites that seamlessly integrate intuitive design with advanced functionality, prioritizing user end experience and business objectives.</p>
