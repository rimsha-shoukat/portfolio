...
function Experties() {
  return (
    ...
    <div className="flex flex-col items-center justify-center max-sm:px-[2rem] px-[6rem] py-[6rem] gap-[1rem] w-[100%] h-auto">
      ...
      <div className="flex max-md:flex-col flex-row gap-[5rem] items-center justify-center w-[100%] h-auto py-[2rem]">
        <div className="flex flex-col gap-[5rem] items-center justify-center max-md:w-[100%] w-[50%]">
        ...
        <div className="flex flex-col gap-[5rem] items-center justify-center max-md:w-[100%] md:w-[50%]">
